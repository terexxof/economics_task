...
def cs_body():
    ...
    # Промежуточный вывод
    st.write(r'''
        Это значит, что в распоряжении предприятия после выплаты налогов останется почти X всей выручки, или xxx руб./год
    ''')
    ...
    ''')
    st.write(f'$E = ({P_b} \cdot (1 - {n}))\ /\ ({K} + {delta_T} \cdot {P_b} \cdot (1 - {n})) = {E} > {E_n} + X$')
    st.write(r'''
